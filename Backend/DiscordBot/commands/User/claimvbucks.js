...
module.exports = {
    commandInfo: {
        name: "claimvbucks",
        description: "Claim your daily 375 V-Bucks"
    },
    async execute(interaction) {
        try {
            ...
            const updateCommonCore = { $inc: { 'profiles.common_core.items.Currency:MtxPurchased.quantity': 375 } };
            const updateProfile0 = { $inc: { 'profiles.profile0.items.Currency:MtxPurchased.quantity': 375 } };
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(`You have claimed your daily **375 V-Bucks**!`)
